...
void
hdc_set_double_path(struct hdc_t* tree, const char* path, int ndim, size_t* shape, void* data, Flags _flags); /**  */
...
void
hdc_set_float_path(struct hdc_t* tree, const char* path, int ndim, size_t* shape, void* data, Flags _flags); /**  */
