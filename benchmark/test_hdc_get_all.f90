    ...
    subroutine f_main()
        ...
        do k = 10, 100001, 1000
            ...
            do k2 = 1,NSTATS
                ...
                call hdc_get(magnetics,"flux_loop(i1)/name",string_out)
                call hdc_get(magnetics,"flux_loop(i1)/identifier",string_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/r",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/r_error_upper",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/r_error_lower",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/z",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/z_error_upper",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/z_error_lower",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/phi",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/phi_error_upper",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/position(i2)/phi_error_lower",float0array_out)
                call hdc_get(magnetics,"flux_loop(i1)/flux/data",data_out)
                call hdc_get(magnetics,"flux_loop(i1)/flux/data_error_upper",data_out)
                call hdc_get(magnetics,"flux_loop(i1)/flux/data_error_lower",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/name",string_out)
                call hdc_get(magnetics,"bpol_probe(i1)/identifier",string_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/r",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/r_error_upper",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/r_error_lower",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/z",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/z_error_upper",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/z_error_lower",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/phi",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/phi_error_upper",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/position/phi_error_lower",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/poloidal_angle",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/poloidal_angle_error_upper",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/poloidal_angle_error_lower",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/toroidal_angle",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/toroidal_angle_error_upper",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/toroidal_angle_error_lower",float0array_out)
                call hdc_get(magnetics,"bpol_probe(i1)/area",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/area_error_upper",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/area_error_lower",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/lenght",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/lenght_error_upper",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/lenght_error_lower",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/lenght_error_turns",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/field/data",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/field/data_error_upper",data_out)
                call hdc_get(magnetics,"bpol_probe(i1)/field/data_error_lower",data_out)
                call hdc_get(magnetics,"method(i1)/name",string_out)
                call hdc_get(magnetics,"method(i1)/ip/data",data_out)
                call hdc_get(magnetics,"method(i1)/ip/data_error_upper",data_out)
                call hdc_get(magnetics,"method(i1)/ip/data_error_lower",data_out)
                call hdc_get(magnetics,"method(i1)/diamagnetic_flux/data",data_out)
                call hdc_get(magnetics,"method(i1)/diamagnetic_flux/data_error_upper",data_out)
                call hdc_get(magnetics,"method(i1)/diamagnetic_flux/data_error_lower",data_out)
